...
const ExpenseForm = ({ expenseData, isOpen, onClose, refreshData }) => {
    ...
    // Body scroll lock jab modal khula ho
    useEffect(() => {
        if (isOpen) {
                ...
                <form onSubmit={submitData} className={styles.form}>
                    <div className={styles.grid}>
                        ...
                        <div className={styles.field}>
                            ...
                            <input type="number" value={amount} onChange={(e) => setAmount(Number(e.target.value))} className={styles.input} placeholder="0.00" />
                        </div>
                    </div>

                    <div className={styles.field}>
                        <label className={styles.label}>Description</label>
                        <input type="text" value={description} onChange={(e) => setDescription(e.target.value)} className={styles.input} placeholder="What was this for?" />
                    </div>
